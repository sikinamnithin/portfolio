...
export default function Hero() {
  ...
  return (
    <section
      id="hero"
      className="min-h-screen flex items-center bg-white dark:bg-gray-900 pt-20 lg:pt-0 relative overflow-hidden"
    >
      <div className="max-w-7xl mx-auto px-8 lg:px-16 w-full">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="space-y-4">
              ...
              <motion.h1
                ...
                className="text-5xl lg:text-7xl font-bold text-gray-900 dark:text-white tracking-tight"
              >
               Sikinam Nithin 
              </motion.h1>
              <motion.h2
            ...
            >
              I build production systems that serve real users. Currently leading
              development at ai4lex. I also study and discuss the mathematics behind
            ...
            >
              <div className="flex items-center gap-8">
                {/* Go */}
                <div className="text-blue-500 dark:text-blue-400 hover:text-blue-600 dark:hover:text-blue-300 transition-colors" title="Go">
                  <svg className="w-14 h-14" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="currentColor">
                ...
                {/* Solana */}
                <div className="text-purple-500 dark:text-purple-400 hover:text-purple-600 dark:hover:text-purple-300 transition-colors" title="Solana">
                  <svg className="w-10 h-10" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="currentColor">
                ...
                {/* PyTorch */}
                <div className="text-orange-500 dark:text-orange-400 hover:text-orange-600 dark:hover:text-orange-300 transition-colors" title="PyTorch">
                  <svg className="w-10 h-10" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="currentColor">
                ...
                {/* Azure */}
                <div className="hover:scale-110 transition-transform" title="Microsoft Azure">
                  <svg className="w-10 h-10" viewBox="0 0 96 96" xmlns="http://www.w3.org/2000/svg">
                    <defs>
                ...
                {/* Kubernetes */}
                <div className="text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 transition-colors" title="Kubernetes">
                  <svg className="w-10 h-10" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="currentColor">
          ...
          >
            <div className="bg-gray-900 dark:bg-gray-800 rounded-lg overflow-hidden border border-gray-800 dark:border-gray-700 shadow-2xl">
              <div className="flex items-center gap-2 px-4 py-3 bg-gray-800 dark:bg-gray-700 border-b border-gray-700 dark:border-gray-600">
              ...
              <div className="p-6 font-mono text-sm space-y-2">
                <p className="text-green-400">{text}<span className="animate-pulse">_</span></p>
                <p className="text-gray-500">// Stack: Golang, Next.js, TypeScript</p>
                <p className="text-gray-500">// Mobile: Android, Kotlin, React Native</p>
                <p className="text-gray-500">// AI: RAG, GraphRAG, LLM Fine-tuning</p>
                <p className="text-gray-500">// Cloud: Azure Architecture & DevOps</p>
              </div>
            </div>
          </motion.div>
        </div>
